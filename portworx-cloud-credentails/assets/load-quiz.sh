...
ssh -o strictHostKeyChecking=no  node01 /opt/pwx/bin/pxctl cred create --provider s3 --s3-access-key ZZYYXXWWVVUU --s3-secret-key 0ldSup3rS3cr3t --s3-region us-east-1 --s3-endpoint http://$MINIO_ENDPOINT objectstore-2
