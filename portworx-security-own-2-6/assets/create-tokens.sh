...
ssh node01 "pxctl context set context user-context1; pxctl volume create app-volume-1 --size 2 --io_priority high"

ssh node01 "pxctl context set context user-context2; pxctl volume create test-volume-1 --size 2 --io_priority high"

ssh node01 "pxctl volume access update --groups developer:a --owner \"Aaron Ramsey\"  app-volume-1"

ssh node01 "pxctl volume access update --groups tester:w --owner \"Gabi Martin\"  test-volume-1"
