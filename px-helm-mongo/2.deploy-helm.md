...
Check out helm charts [here](https://github.com/kubernetes/charts/), in a couple of steps we will be installing the Mongo chart but first we need to create a storage class and PVC.
