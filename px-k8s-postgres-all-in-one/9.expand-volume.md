...
Now that you have expanded the volume you can go back to the step above and run the benchmark again. Make sure you ```exit```{{execute T1}} the container shell before you proceed.
