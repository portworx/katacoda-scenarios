...
The parameters are declarative policies for your storage volume. See [here](https://docs.portworx.com/reference/cli/create-and-manage-volumes/) for a full list of supported parameters.
...
Now that we have the volumes created, let's deploy Redis !
