...
Take a look at the StorageClass definition for Portworx ```cat px-repl3-sc.yaml```{{execute T1}}
...
Take a look at the Persistent Volume Claim ```cat px-postgres-pvc.yaml```{{execute T1}}
